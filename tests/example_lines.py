...
bbox_style2 = dict(
    xy_crs=4326,
    fontsize=8,
    bbox=dict(boxstyle="round,pad=0.25", ec="k", fc="r", alpha=0.25),
)
...
m.add_annotation(xy=l2[0], text="start", xytext=(10, 20), **bbox_style2)
m.add_annotation(xy=l2[-1], text="end", xytext=(-30, -20), **bbox_style2)
...
common_args = dict(fontsize=6, xy_crs=4326)
m.add_annotation(
    xy=l3[1],
    text="geodesic lines",
    **common_args,
